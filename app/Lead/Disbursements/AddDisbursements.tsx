...
const AddDisbursements: React.FC = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const documents = [
      { field: "disbursement_letter", name: "disbursement_letter", uri: disbursementImage },
    ...
    const requestBody: DisbursementDetailsParams = {
      ...
      disbursement_type: data.disbursal_type.toLowerCase(),
      documents: [
    ...
    console.log("disbursementImage", disbursementImage);
    console.log("bankerConfirmationImage", bankerConfirmationImage, keys);
...
export default AddDisbursements;
